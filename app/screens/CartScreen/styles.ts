...
export const styles = StyleSheet.create({
  ...
  submitButtonStyle: {
    width: widthUtils(50, 100).width,
    height: widthUtils(50, 100).height,
    marginLeft: 10,
    marginRight: 0,
    fontWeight: "500",
    color: "white",
...
export const modalStyles = StyleSheet.create({
  ...
  quantityInputCancelText: {
    fontSize: fontSize(15),
    fontWeight: "500",
    color: "#333333",
    textAlign: "center",
  },
  quantityInputConfirmText: {
    fontSize: fontSize(15),
    fontWeight: "500",
    color: "#ffffff",
    textAlign: "center",
