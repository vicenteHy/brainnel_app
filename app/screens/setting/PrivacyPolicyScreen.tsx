...
export const PrivacyPolicyScreen = () => {
  ...
  const getContentByLanguage = (data: PrivacyPolicyData): string => {
    ...
    if (currentLanguage.startsWith('fr') && data.info_fr) {
      return data.info_fr;
    } else if (currentLanguage.startsWith('ar') && data.info_ar) {
      return data.info_ar;
    } else {
      // 默认返回英文内容
      return data.info;
      ...
      if (response && typeof response === 'object') {
        ...
        if (data.info) {
          ...
          if (typeof response === 'string') {
            ...
            throw new Error('隐私政策内容格式错误: 未找到info字段');
          }
        }
